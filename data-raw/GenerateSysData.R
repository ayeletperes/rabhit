...
GENE.loc <- list(
  ...
  IGH = c("IGHV3-74","IGHV3-73","IGHV3-72","IGHV2-70","IGHV1-69-2","IGHV2-70D",
          "IGHV1-69","IGHV3-66","IGHV3-64", "IGHV4-61" , "IGHV4-59","IGHV1-58","IGHV3-53",
          "IGHV5-51","IGHV3-49","IGHV3-48","IGHV1-46","IGHV1-45","IGHV3-43D","IGHV3-43","IGHV4-39","IGHV4-38-2",
          "IGHV3-38","IGHV4-34","IGHV3-33",
          "IGHV4-31" ,"IGHV4-30-4","IGHV4-30-2" ,"IGHV3-30-3", "IGHV3-30" , "IGHV4-28" ,
          "IGHV2-26" ,"IGHV1-24", "IGHV3-23","IGHV3-21","IGHV3-20","IGHV1-18",
          "IGHV3-15","IGHV3-13", "IGHV3-11" , "IGHV3-9","IGHV5-10-1" , "IGHV1-8","IGHV3-64D", "IGHV3-7",
          "IGHV2-5","IGHV7-4-1","IGHV4-4", "IGHV1-3", "IGHV1-2",  "IGHV6-1",
          "IGHD1-1" ,  "IGHD2-2" , "IGHD3-3", "IGHD6-6" , "IGHD1-7" ,  "IGHD2-8" ,
          "IGHD3-9",  "IGHD3-10"  ,  "IGHD4-11", "IGHD5-12" , "IGHD6-13"  ,
          "IGHD2-15","IGHD3-16",
...
PSEUDO <- list(
  ...
  IGH = c("IGHV3-52","IGHV3-69","IGHV3-47","IGHV3-71","IGHV3-22","IGHV4-55","IGHV1-68","IGHV2-10","IGHV5-78","IGHV3-32","IGHV3-33-2","IGHV3-38-3",
          ...
          "IGHV1-f","IGHV3-30-33","IGHV3-38","IGHV7-81","IGHV3-35","IGHV3-16","IGHV3-30-52","IGHV1-69D", "IGHD1-14"),
...
HVGERM <- seqinr::read.fasta('data-raw/HVGERM_6_3.fasta',as.string = T)
HDGERM <- seqinr::read.fasta('data-raw/HDGERM_23_7.fasta',as.string = T)
HJGERM <- seqinr::read.fasta('data-raw/HJGERM_23_7.fasta',as.string = T)

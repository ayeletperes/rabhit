...
An example dataset is provided with the `haplotyper` package. It contains unique naive b-cell
...
3. Graphical output of the inferred haplotype 
4. Graphical output of the inferred deletion 
